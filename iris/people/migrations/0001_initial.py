    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_id', models.CharField(help_text=b'000-0000000-0', max_length=22)),
                ('email', models.EmailField(max_length=254, blank=True)),
                ('person_type', models.CharField(max_length=1, null=True, choices=[(b'E', b'Employee'), (b'M', b'Member'), (b'D', b'Doctor'), (b'S', b'Supplier')])),
                ...
                ('nationality', models.ForeignKey(to='location.Nationality')),
