...
function ajax_add_star(event, url) {
	...
	{},
        function(data){
	    if (data == 'True' ) {
		$(event).html('<img style="width: 26px; margin: -6px;" iris="/static/report_builder/img/star.png">');
	    } else {
		$(event).html('<img style="width: 26px; margin: -6px;" iris="/static/report_builder/img/unstar.png">');
	    }
        }
    );}
